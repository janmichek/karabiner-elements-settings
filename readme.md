<div style="margin-bottom: 24px;">
  <h2>Overview</h2>
  <p>Custom Karabiner Elements configuration for enhanced productivity across multiple applications and system-wide keyboard shortcuts.</p>
  <p><strong>Features:</strong></p>
  <ul>
    <li><strong>App-Specific Shortcuts:</strong> Optimized keybindings for Firefox, WebStorm, Ableton Live, and Finder</li>
    <li><strong>App Launcher:</strong> Caps Lock + letter combinations to quickly open any application</li>
    <li><strong>System Controls:</strong> Media playback, volume, brightness control via function keys</li>
    <li><strong>Navigation Enhancements:</strong> Word-level selection and movement, cursor positioning</li>
    <li><strong>IDE Productivity:</strong> Custom shortcuts for coding tasks in WebStorm (git operations, file search, terminal)</li>
  </ul>
</div>
